...
class SettingsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $settings = [
            // Store Info
            ['module' => 'SITE', 'key' => 'storeName', 'value' => 'dotoydo'],
            ['module' => 'SITE', 'key' => 'brandTagline', 'value' => 'Your Everyday Mart — Toys, Electronics, Home & More'],
            ['module' => 'SITE', 'key' => 'contactEmail', 'value' => 'support@dotoydo.com'],
            ['module' => 'SITE', 'key' => 'storeEmail', 'value' => 'support@dotoydo.com'],
            ...
            ['module' => 'SHIPPING', 'key' => 'shippingPickupAddress', 'value' => 'dotoydo Fulfillment Center, Bangalore, Karnataka, India'],
            ['module' => 'SHIPPING', 'key' => 'shippingReturnAddress', 'value' => 'dotoydo Returns, Bangalore, Karnataka, India'],
            ...
            // SMTP
            ['module' => 'SMTP', 'key' => 'fromEmailAddress', 'value' => 'support@dotoydo.com'],
            ...
            ['module' => 'SITE', 'key' => 'chatWelcomeMessage', 'value' => '👋 Hi there! Looking for a toy, gadget, or something for your home? Ask us anything!'],
            ...
            ['module' => 'SITE', 'key' => 'chatSupportName', 'value' => 'dotoydo Care Team'],
